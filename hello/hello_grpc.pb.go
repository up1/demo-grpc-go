...
type HelloWorldClient interface {
	SayHi(ctx context.Context, in *Hello, opts ...grpc.CallOption) (*HelloResponse, error)
}
...
func (c *helloWorldClient) SayHi(ctx context.Context, in *Hello, opts ...grpc.CallOption) (*HelloResponse, error) {
	out := new(HelloResponse)
	err := c.cc.Invoke(ctx, "/hello.HelloWorld/SayHi", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HelloWorldServer interface {
	SayHi(context.Context, *Hello) (*HelloResponse, error)
...
func (UnimplementedHelloWorldServer) SayHi(context.Context, *Hello) (*HelloResponse, error) {
...
func _HelloWorld_SayHi_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hello.HelloWorld/SayHi",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloWorldServer).SayHi(ctx, req.(*Hello))
	}
